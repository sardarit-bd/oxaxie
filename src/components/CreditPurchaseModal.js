...
//         } else {
//           alert('Credit purchase initiated! Redirecting to payment...');
//           onClose();
//         }
//       } else {
...
//         {/* Available Credits */}
//         {availableCredits > 0 && (
//           <div className="bg-[#F59F0A] border border-blue-200 rounded-lg p-3 mb-4">
...
//                 hover:bg-[#F59F0A] transition transform hover:scale-105
//                 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer
//                 ${selectedAmount === amount ? 'ring-4 ring-green-300' : ''}
//               `}
//             >
//               ${amount}
//             </button>
...
//             <div className="animate-spin inline-block w-5 h-5 border-2 border-green-600 border-t-transparent rounded-full mr-2"></div>
//             Processing...
//           </div>
//         )}
...
//           onClick={onClose}
//           disabled={isProcessing}
//           className="w-full bg-gray-200 text-gray-700 px-4 py-2 rounded-lg font-semibold hover:bg-gray-300 transition disabled:opacity-50"
//         >
//           Cancel
//         </button>
//       </div>
